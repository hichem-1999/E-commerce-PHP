...
<script src="inc/xhr.js" type="text/javascript"></script>
	<script src="inc/Ajax_search.js" type="text/javascript"></script>
...
<body>
    ...
    <section class="shop spad">
		...
		<?php } ?>
                ...
                <div class="col-lg-9" id="resultat">
                        ...
                        <?php foreach ($data["products"] as $p) { ?>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <button class="main-btn quick-view"><i class="fa fa-search-plus"></i><a href="<?php echo URLROOT ?>products/details?id=<?php echo($p->id);?>"> Quick view</a></button>
                                        <ul class="product__hover">
                                            ...
                                            <li><a href="#"><img src="<?php echo URLROOT ?>/public/img/icon/search.png" alt=""></a></li>
                                        </ul>
                                    </div>
